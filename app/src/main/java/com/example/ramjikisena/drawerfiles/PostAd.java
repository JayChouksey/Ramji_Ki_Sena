...
public class PostAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String postMessage = editTextPost.getText().toString().trim();
                String name = editTextName.getText().toString().trim();
                String contact = editTextContact.getText().toString().trim();

                String message = "Name: " + name + "\n\nContact: " + contact + "\n\nFeedback: " + postMessage;
                if (!postMessage.isEmpty() && !name.isEmpty() && !contact.isEmpty()){
 ...
 /*                   // Send message via Email
                    ...
                    Toast.makeText(PostAd.this, "Fill all details.", Toast.LENGTH_SHORT).show();
                }
            }
        });

        // To go from  PostAd to Profile
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PostAd.this, Profile.class);
