...
public class ImportantTemples extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_important_temples);
        ...
        // To go from Important Temples to Important Temples
        ...
        temples.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String check = intentSend.getStringExtra("checkPrev") ;

                // Start the second activity
                Intent intent = new Intent(ImportantTemples.this, ImportantTemples.class);
                intent.putExtra("checkPrev",check);
                startActivity(intent);
            }
        });

        // To go from Important Temples to Mission
        ...
        mission.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Start the second activity
                Intent intent = new Intent(ImportantTemples.this, Mission.class);
                intent.putExtra("checkPrev",check);
                startActivity(intent);
            }
        });

        // To go from Important Temples to Glory of Ram Naam
        ...
        ramNaamGlory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Start the second activity
                Intent intent = new Intent(ImportantTemples.this, GloryOfRamnaam.class);
                intent.putExtra("checkPrev",check);
                startActivity(intent);
            }
        });

        // To go from Important Temples to Writing Experience
        ...
        write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Start the second activity
                Intent intent = new Intent(ImportantTemples.this, WritingExperience.class);
                intent.putExtra("checkPrev",check);
                startActivity(intent);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(check.equals("main")){
                    Intent intent2 = new Intent(ImportantTemples.this, MainActivity.class);
